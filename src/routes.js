...
const Addnewcar = React.lazy(() => import("./views/products/Addnewcar"));
const Availablecars = React.lazy(() =>
  import("./views/products/Availablecars")
);

const AddUser = React.lazy(() => import("./views/users/AddUser"));
const TotalUsers = React.lazy(() => import("./views/users/TotalUsers"));
...
const routes = [
  ...
  { path: "/products/Addnewcar", name: "Add New Car", element: Addnewcar },
  {
    path: "/products/Availablecars",
    name: "Available Cars",
    element: Availablecars,
  },
  { path: "/users/AddUser", name: "Add New User", element: AddUser },
  { path: "/users/TotalUsers", name: "Total Users", element: TotalUsers },
